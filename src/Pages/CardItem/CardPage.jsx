...
export default function CardPage() {
    return (
        <>
            <div className="py-5">
                <div className="carousel w-auto h-[500px] items-center" >
                    <div id="item1" className="carousel-item w-full">
                        <img src="https://wallpapercave.com/wp/wp6396428.jpg" alt="1" className="" />
                    </div>
                    <div id="item2" className="carousel-item w-full">
                        <img src="https://wallpapercave.com/wp/wp6396362.jpg" alt="2" className="" />
                    </div>
                    <div id="item3" className="carousel-item w-full">
                        <img src="https://wallpapercave.com/wp/wp6396116.jpg" alt="3" className="" />
                    </div>
                    <div id="item4" className="carousel-item w-full">
                        <img src="https://wallpapercave.com/wp/wp6358555.jpg" alt="4" className="" />
                    </div>
                </div>
            ...
            <div className="px-64 pb-10 pt-10">
                <div>
                    <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r to-purple-500 from-black">
                            Buytix:<br></br>
                        </span>
                        Order Now!
                    </h1>
                ...
                <div className="grid grid-cols-3 pt-10 text-justify gap-10">
                    <div className="col-span-2">
                        <h2 className="pb-10 text-purple-500">
                            <b>Description</b><br />
                        </h2>
                        <p>
            ...
            <div>
                <footer className="footer items-center p-4 bg-neutral text-neutral-content px-64">
